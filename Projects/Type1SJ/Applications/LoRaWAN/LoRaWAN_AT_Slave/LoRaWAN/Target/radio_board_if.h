...
#elif USE_MURATA_SX126X //@Murata Use Murata Sx126x
#include "muratasx126xmodule.h"

#define Sx_Board_IoInit            SX126x_RADIO_IoInit
#define Sx_Board_IoDeInit          SX126x_RADIO_IoDeInit
#define Sx_Board_IoIrqInit         SX126x_RADIO_IoIrqInit
#define Sx_Board_SendRecv          SX126x_RADIO_SendRecv
#define Sx_Board_ChipSelect        SX126x_RADIO_ChipSelect
#define Sx_Board_CheckRfFrequency  SX126x_RADIO_CheckRfFrequency
#define Sx_Board_Reset             SX126x_RADIO_Reset
#define Sx_Board_SetXO             SX126x_RADIO_SetXO
#define Sx_Board_GetWakeUpTime     SX126x_RADIO_GetWakeUpTime
#define Sx_Board_GetPaSelect       SX126x_RADIO_GetPaSelect
#define Sx_Board_SetAntSw          SX126x_RADIO_SetAntSw
#define Sx_Board_Bus_Init          SX126x_RADIO_Bus_Init
#define Sx_Board_Bus_deInit        SX126x_RADIO_Bus_deInit
#define Sx_Board_WaitOnBusy        SX126x_RADIO_WaitOnBusy
#define Sx_Board_WakeUp            SX126x_RADIO_WakeUp
#define Sx_Board_IsTcxo            SX126x_RADIO_BoardIsTcxo
#define Sx_Board_SetLedRx          SX126x_RADIO_BoardSetLedRx
#define Sx_Board_SetLedTx          SX126x_RADIO_BoardSetLedTx
#elif SX1272MB2DAS
